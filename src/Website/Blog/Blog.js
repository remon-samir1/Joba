      ...
      <div className="flex py-5 px-8 gap-10 flex-col md:flex-row">
        <div className="flex-1">
          ...
          <div ref={contentRef}>
            ...
            <p dangerouslySetInnerHTML={{__html:blog?.description}} className="text-base text-textColor my-6">
            </p>
          </div>
        </div>
          ...
          <div className="border border-[#ddd] pb-5 px-4 mt-4 rounded ">
        {
          blogs?.map((data)=>(
            ...
            <p dangerouslySetInnerHTML={{__html:StringSlice(data.description , 30)}} className="mt-4 text-text2 text-[1.1rem]">
            {/* {data.description} */}
            </p></Link>
          ))
        }
