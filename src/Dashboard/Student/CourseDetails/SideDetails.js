  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-main rounded-xl px-4 py-6">
        ...
        <p className="text-white font-bold text-[1.5rem] mt-4 uppercase">
          {props.price} 
        </p>
      </div>
      <p className="text-textColor text-[1.3rem] mt-4">
        {t("Course includes :")}
      </p>
      ...
      <p className="text-textColor text-[1.2rem] font-semibold mt-4">
        {t("Share this course:")}
      </p>
      <div className="flex items-center gap-3 mt-5">
        <div className="rounded-full w-[40px] h-[40px]  bg-main flex justify-center items-center cursor-pointer border border-main  hover:bg-transparent duration-500">
          <Icon
            className="text-white hover:text-main duration-300"
      ...
      <button
        ...
        className="mt-8 hover:shadow main-shadow duration-500   text-white bg-main w-full p-3 rounded-lg text-[1.2rem] font-semibold text-center"
      >
        {loading ? (
          <Icon
