...
const OrderDetails = () => {
  return (
    <div className="OrderDetails">
      ...
      <div className="boxes flex justify-center items-center gap-8 mt-8">
        <div className="flex justify-start items-start p-4 h-[344px] gap-3 flex-col flex-1 bg-white">
          <h3 className="text-base font-semibold text-main">Payment status</h3>
          <SelectBox title="paid" />
          <h3 className="text-base font-semibold text-main mt-8">
            Order status
          </h3>
          <SelectBox title="completed" />
          <button className="text-base text-white bg-main px-8 rounded py-2 mt-4">
            Update
          </button>
        </div>
        <div className="flex justify-start items-end h-[344px] gap-3 flex-col flex-1 bg-white">
