    ...
    <div className='Categories'>
      ...
      <div className="table my-8 bg-white ">
        <div className="flex justify-between mb-4 items-center border-b p-4  border-borderColor">
          ...
          <button className="flex justify-between gap-2 items-center text-white bg-[#0048D3] py-2 px-4 rounded-md  border border-[#0048D3] duration-500 hover:bg-white hover:text-[#0048D3]">
          <FaPlus/>
